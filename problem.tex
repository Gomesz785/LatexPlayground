...
\newcommand{\course}{FC 11221}
\newcommand{\coursen}{Calculus}
\newcommand{\semester}{2021} 
\newcommand{\TDAG}{TDAG}
\newcommand{\campus}{Sabaragamuwa University of Sri Lanka}
\newcommand{\dept}{Department of Surveying and Geodesy}
...
\lhead{\TDAG}
\chead{\begin{tabular}[t]{c}\campus \\ \dept \\ \course \\ \coursen \end{tabular}}
\begin{document}
\maketitle
